...
public class VehiclesController {
	...
	public void createMoto(String vehicleMatricula, String vehicleMarca, String vehicleColor) throws Exception {
		Bike moto = new Bike(vehicleMatricula, vehicleMarca, vehicleColor);
		repository.addVehicle(moto);
		// Fase1.3) Afegir-li dues rodes traseres demanant a lï¿½usuari la marca i el
		// diametre.
		Scanner sc = new Scanner(System.in);

		System.out.println("Introdueix informacio roda trasera de la moto");
		...
		// Fase1,4) Afegir-li roda davantera demanant a l'usuari la marca i el
		// diametre.
		System.out.println("Introdueix informacio roda davantera de la moto");
		...
		Wheel rodaDavant = new Wheel(marcaRoda, diametreRoda);
	...
	public void createCoche(String vehicleMatricula, String vehicleMarca, String vehicleColor) throws Exception {
		...
		//  Afegir-li dues rodes davanteres demanant a lï¿½usuari la marca i el
		// diametre.
